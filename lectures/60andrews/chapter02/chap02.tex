...
\newpage
\ti{Simple co example, no interference}
{\bf  Co rule}
 \[
 \frac{\stm{P_i}{Si}{Q_i}\mbox{\ are interference free}}
      {\stm{P_1\land ... \land P_n}{co S1; // ... // Sn; oc}{Q_1\land ... \land Q_n}}
...
\begin{Verbatim}
  ...
  \(\{x = 1 \wedge y = 1\}\)
\end{Verbatim}
To prove this we need to prove both of the following:
\begin{multicols}{2}
\begin{Verbatim}
  \(\{x = 0\}\)
  x = x + 1;
...
\end{Verbatim}
\end{multicols}
Each of these is a straightforward application of the assignment
axiom.

Further, neither assignment interferes with an assertion
in the other process, since all variables are distinct.
